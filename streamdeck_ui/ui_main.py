...
from PySide6.QtWidgets import (QComboBox, QGridLayout, QGroupBox, QHBoxLayout,
    QLayout, QMenu, QMenuBar, QProgressBar,
...
class Ui_MainWindow:
    def setupUi(self, MainWindow):
        ...
        icon1 = QIcon()
        icon1.addFile(":/icons/icons/add_page.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(":/icons/icons/remove_page.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.add_button_state.setObjectName("add_button_state")
        ...
        self.remove_button_state.setObjectName("remove_button_state")
        ...
        self.button_states.setObjectName("button_states")
        self.tab = QWidget()
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", "Stream Deck UI", None))
        ...
        self.actionDocs.setText(QCoreApplication.translate("MainWindow", "Documentation", None))
        self.actionGithub.setText(QCoreApplication.translate("MainWindow", "Github", None))
        self.actionAbout.setText(QCoreApplication.translate("MainWindow", "About...", None))
        self.settingsButton.setText("")
        self.cpu_usage.setFormat("")
#if QT_CONFIG(tooltip)
        self.add_page.setToolTip(QCoreApplication.translate("MainWindow", "Add new page", None))
#endif // QT_CONFIG(tooltip)
        self.add_page.setText("")
#if QT_CONFIG(tooltip)
        self.remove_page.setToolTip(QCoreApplication.translate("MainWindow", "Delete current page", None))
#endif // QT_CONFIG(tooltip)
        self.remove_page.setText("")
        self.pages.setTabText(self.pages.indexOf(self.page_1), "")
        self.groupBox.setTitle(QCoreApplication.translate("MainWindow", "Configure Button", None))
#if QT_CONFIG(tooltip)
        self.add_button_state.setToolTip(QCoreApplication.translate("MainWindow", "Add a new button state", None))
#endif // QT_CONFIG(tooltip)
        self.add_button_state.setText("")
#if QT_CONFIG(tooltip)
        self.remove_button_state.setToolTip(QCoreApplication.translate("MainWindow", "Remove current selected button state", None))
#endif // QT_CONFIG(tooltip)
